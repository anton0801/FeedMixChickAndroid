...
class FeedMixChSystemServiceI(private val context: Context) {
    ...
    suspend fun feedMixRetriveDeviceGaid(): String = withContext(Dispatchers.IO) {
        ...
        Log.d(MainApplication.FEED_MIX_MAIN_TAG, "Gaid: $gaid")
    ...
    fun getAppsflyerIdForApp(): String {
        ...
        Log.d(MainApplication.FEED_MIX_MAIN_TAG, "AppsFlyer: AppsFlyer Id = $appsflyrid")
        return appsflyrid
    }
